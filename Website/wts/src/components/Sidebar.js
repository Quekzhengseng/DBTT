...
import { 
  MessageSquare, Upload, Plus, Image
} from "lucide-react"
          ...
          {conversations.map((conversation) => (
            <div
              ...
              style={{ 
                ...
                cursor: "pointer", 
                backgroundColor: currentConversation === conversation.id ? "rgba(62, 175, 219, 0.1)" : "transparent",
                borderLeft: currentConversation === conversation.id ? "3px solid #3eafdb" : "3px solid transparent",
  ...
  return (
    <div style={{ 
      ...
      <div style={{ padding: "1rem", borderBottom: "1px solid rgba(229, 231, 235, 0.5)" }}>
        ...
        <h2 style={{ fontSize: "0.875rem", fontWeight: "500", color: "#4b5563", marginTop: "0.5rem" }}>
          Newest AI chatbot
        </h2>
      </div>
      ...
      <div style={{ 
        ...
        {loading ? (
          ...
          <div>
            ...
            {renderConversationGroup("Previous 7 days", groupedConversations.previousWeek)}
            {renderConversationGroup("Previous 30 days", groupedConversations.older)}
